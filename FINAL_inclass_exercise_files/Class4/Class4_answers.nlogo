turtles-own [ friend enemy buddy ]
...
to basic2 
  ...
  ask turtles [
    set buddy one-of other turtles
    face buddy
    fd 2
  ]
end
...
to tag-go
  ...
  ask turtles with [color = red] [
    set heading towards one-of other turtles
    fd 1
...
basic2</setup>
  ...
  <experiment name="non-static" repetitions="1" runMetricsEveryStep="false">
    <setup>non-static
ask patch 0 2 [set plabel "true"]</setup>
    <go>if ticks mod 500 = 0 [ask patch 0 2 [set plabel "false"]]
if (mean [xcor] of turtles != plabel of [patch 0 0]) or (mean [ycor] of turtles !- plabel of [patch 0 1]) [ask patch 0 2 [set plabel [true]]]
ask patch 0 0 [set plabel mean [xcor] of turtles]
ask patch 0 1 [set plabel mean [ycor] of turtles]
if ticks mod 500 = 0 [ask patch 0 2 [set plabel "false"]]
go</go>
    <timeLimit steps="10000"/>
    <metric>(ticks &lt; 5000) or (variance [xcor] of turtles &lt; .1)</metric>
    <metric>(ticks &lt; 5000) or (variance [ycor] of turtles &lt; .1)</metric>
    <metric>(ticks &lt; 5000) or (ticks mod 500 != 490) or (plabel of [patch 0 2] = "true")</metric>
    <enumeratedValueSet variable="personalities">
      <value value="&quot;mixed&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="number">
