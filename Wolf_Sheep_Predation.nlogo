...
;    set heading 90
    set energy 100
    set time-between-meals []
    set ticks-since-last-meal 0
  ]
...
to wiggle
  right random 90
  left random 90 ;; right random 180 - 90
end
...
to eat-grass
  if ( grass-amount >= energy-gain-from-grass) [
    ...
    recolor-grass ;; Make a note of this -- patch variables accessible
  ]
end
...
"" ""
PENS
"heading" 1.0 1 -16777216 true "" "histogram [heading] of turtles"
...
@#$#@#$#@
<experiments>
  <experiment name="Longevity" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    ...
    <steppedValueSet variable="energy-gain-from-sheep" first="2" step="0.2" last="5"/>
