...
to setup3
  ...
  [
    ...
    set color scale-color blue ycor -16 16
  ]
  reset-ticks
end
...
to go3
  ask turtles
  [
    ask patch-here [set pcolor scale-color yellow pxcor -16 16]
    fd 3
  ]
end
...
@#$#@#$#@
<experiments>
  <experiment name="step1" repetitions="1" runMetricsEveryStep="true">
...
reset-ticks</final>
  ...
  <experiment name="step2" repetitions="1" runMetricsEveryStep="true">
    <setup>random-seed 17638974
setup2</setup>
    <go>go2</go>
    <final>ca
